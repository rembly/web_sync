...
class OauthToken
  ...
  SERVICE_ACCOUNT_KEY_FILE = 'google_sheet_sync.json'
  ...
  FUSION_TABLE_READWRITE_SCOPE = 'https://www.googleapis.com/auth/fusiontables'
  ...
  def self.google_service_token
    authorizer = Google::Auth::ServiceAccountCredentials.make_creds(
      json_key_io: File.open(SERVICE_ACCOUNT_KEY_FILE), scope: [GOOGLE_SHEET_READONLY_SCOPE, FUSION_TABLE_READWRITE_SCOPE]
    )
